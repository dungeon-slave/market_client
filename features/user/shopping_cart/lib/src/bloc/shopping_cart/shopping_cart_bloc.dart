...
class ShoppingCartBloc extends Bloc<ShoppingCartEvent, ShoppingCartState> {
  ...
  void _init(_, Emitter<ShoppingCartState> emit) {
    try {
      emit(
        state.copyWith(
          isLoading: false,
  ...
  Future<void> _clearCart(_, Emitter<ShoppingCartState> emit) async {
  ...
  Future<void> _checkout(_, Emitter<ShoppingCartState> emit) async {
    try {
